...
```{r}
# load lyrics data
load('/Users/admin/Desktop/Project1/data/lyrics.RData') 
```
...
# remove stop words
data("stop_words")
word <- c("lot", "today", "months", "month", "wanna", "wouldnt", "wasnt", "ha", "na", "ooh", "da", "gonna", "im", "dont", "aint", "wont", "yeah", "la", "oi", "nigga", "fuck", "hey", "year", "years", "last", "past", "feel", "love","niggas")
...
```{r export data}
save(dt_lyrics, file="/Users/admin/Desktop/Project1/output/processed_lyrics.RData1")
```
